...
export function Sidebar({ isMobileOpen = false, onCloseMobile = () => {} }) {
  ...
  const handleNavigation = (path) => {
    router.push(path)
    onCloseMobile() // Cierra el sidebar en móvil después de navegar
  }
  ...
  return (
    <div>
      ...
      {/* Sidebar - versión desktop (fija) y móvil (deslizable) */}
      <div 
        className={`fixed inset-y-0 left-0 w-80 max-w-[80%] bg-sidebar border-r border-sidebar-border z-40 
                    transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:w-64
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 p-4 space-y-2">
            ...
            <Button
              ...
              onClick={() => handleNavigation("/dashboard/rubros")}
            >
            ...
            <Button
              ...
              onClick={() => handleNavigation("/dashboard/permisos")}
            >
